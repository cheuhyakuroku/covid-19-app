...
class MyColors {
  static List<Color> bg = [Color(0xFF52075B), Color(0xFF883B77)];
  static Color white = const Color(0xFFFFFFFF);
  static Color black = Color(0xff040405);
  static Color purpleOpa = Colors.purple.withOpacity(0.25);
  static Color yellowOpa = Colors.yellow.withOpacity(0.25);
  static Color greenleOpa = Colors.green.withOpacity(0.25);
  static Color redOpa = Colors.red.withOpacity(0.25);
}
...
class LightColor {
  ...
  static const Color cardColor = Color(0xfff7f5f4);
  static const Color darkgrey = Color(0xff4E585A);
